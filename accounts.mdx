---
title: "Accounts and Persistent Sessions in Crafted Gamz"
sidebarTitle: "Accounts"
description: "Sign in with Google, GitHub, or email to sync your settings, bookmarks, pins, installed apps, and session state across visits."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Platform Statistics" icon="chart-bar" href="/introduction">
    Account-linked activity contributes to per-user statistics visible in the top bar and platform stats widgets.
  </Card>
</CardGroup>
