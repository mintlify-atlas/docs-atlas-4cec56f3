...
sidebarTitle: "Proxy"
description: "Crafted Gamz routes web traffic through Ultraviolet and Scramjet proxy engines over Wisp WebSocket connections, enabling full open-web access from within the platform."
---
...
- Major programmatic ad platforms (Google, Amazon, AppNexus, Rubicon, PubMatic, Criteo, OpenX, Index Exchange)
- Social ad networks (Facebook, Twitter/X, Yahoo)
- Mobile ad SDKs (Unity Ads, AppLovin, Vungle, IronSource, Fyber, Smaato, Tapjoy, AdColony, Chartboost)
